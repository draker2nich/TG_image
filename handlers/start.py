...
# Команды-escape, работающие из любого состояния
ESCAPE_COMMANDS = ["start", "menu", "cancel"]
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        ...
        f"📌 Выберите тип контента для генерации:\n"
        f"• 🎭 Видео с аватаром (HeyGen)\n"
        f"• 📝 SEO-статьи (ChatGPT)\n"
        f"• 🎬 Короткие видео (Sora 2 / Veo 3){warning}",
...
async def cmd_help(message: Message):
    ...
    await message.answer(
        ...
        "Сценарий генерируется на основе вашей базы знаний.\n\n"
        "📝 <b>SEO-статьи</b> — генерация оптимизированных статей через ChatGPT "
        "с использованием вашей базы знаний.\n\n"
        "🎬 <b>Короткие видео</b> — генерация видео через Sora 2 или Veo 3.1.\n\n"
        "📚 <b>База знаний</b> — загрузите файлы, чтобы бот использовал "
        "вашу информацию при генерации контента.",
        parse_mode="HTML",
...
async def cmd_status(message: Message):
    ...
    model_names = {"sora2": "Sora 2", "veo3_fast": "Veo 3.1 Fast", "veo3": "Veo 3.1 Quality", "heygen": "HeyGen"}
